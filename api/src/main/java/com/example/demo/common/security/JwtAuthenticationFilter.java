    ...
    protected void doFilterInternal(
        ...
        try {
            ...
            if (StringUtils.hasText(token)) {
                final AccessTokenPayload payload = tokenProvider.parseAccessTokenPayload(token);
                final var authentication = new UsernamePasswordAuthenticationToken(
                        new AuthPrincipal(payload.userId()),
                        null,
                        List.of(new SimpleGrantedAuthority(payload.role().authority())));
