...
class DemoApplicationTests {
    ...
    void swagger_ui와_openapi_문서를_설정된_메타데이터와_함께_제공한다() throws Exception {
        ...
        mockMvc.perform(get("/v3/api-docs"))
                ...
                .andExpect(jsonPath("$.paths['/api/v1/regions/nearby'].get.parameters[0].name")
                        .value("latitude"))
                .andExpect(jsonPath("$.paths['/api/v1/regions/nearby'].get.parameters[0].in")
                        .value("query"))
                .andExpect(jsonPath("$.paths['/api/v1/regions/nearby'].get.parameters[1].name")
                        .value("longitude"))
                .andExpect(jsonPath("$.paths['/api/v1/regions/nearby'].get.parameters[1].in")
                        .value("query"))
